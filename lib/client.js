...
.alg-header-btn:hover {
  background: var(--dsw-alias-bg-layer-hover, rgba(255, 255, 255, 0.03));
}
.alg-chevron {
  margin-left: auto;
...
.alg-input:focus {
  border-color: var(--dsw-alias-accent-primary, #3b82f6);
}
.alg-checkbox-label {
  display: flex;
  align-items: center;
        ...
        React.createElement('button', {
          ...
          React.createElement('span', { style: { display: 'flex', flexDirection: 'column' } },
            React.createElement('span', { style: { color: 'var(--dsw-alias-label-primary)', fontSize: 15, fontWeight: 600, display: 'flex', alignItems: 'center', gap: 8 } },
              tt('title'),
              React.createElement('span', { style: { fontSize: 11, fontWeight: 500, padding: '2px 6px', borderRadius: 6, background: 'rgba(59,130,246,0.15)', color: 'var(--dsw-alias-accent-primary, #3b82f6)' } }, updateState.currentVersion ? 'v' + updateState.currentVersion : (updateState.checking ? '…' : '—'))
            ),
        ...
        expanded && React.createElement('div', {
          ...
          React.createElement('div', {
            ...
            React.createElement('div', { style: { fontSize: 13, display: 'flex', alignItems: 'center', gap: 8 } },
              ...
              updateState.error && React.createElement('span', { style: { color: 'var(--dsw-alias-status-danger, #ef4444)', fontSize: 12 } }, updateState.error)
            ),
          ...
          updateState.notice && React.createElement('div', {
            style: { padding: '8px 12px', marginBottom: 12, background: 'rgba(16,185,129,0.1)', color: 'var(--dsw-alias-status-success, #10b981)', borderRadius: 6, fontSize: 12, border: '1px solid rgba(16,185,129,0.2)' }
          }, updateState.notice),
          ...
          React.createElement('div', {
            ...
            React.createElement('div', { style: { fontSize: 12, color: 'var(--dsw-alias-label-secondary)' } },
              telemetry.error
                ? React.createElement('span', { style: { color: 'var(--dsw-alias-status-danger, #ef4444)' } }, telemetry.error)
          ...
          React.createElement('div', {
            ...
            msg && React.createElement('span', { style: { fontSize: 13, color: msg === tt('saved') || msg === tt('statsResetDone') ? 'var(--dsw-alias-status-success, #10b981)' : 'var(--dsw-alias-status-danger, #ef4444)' } }, msg)
          )
        )
      );
    }
