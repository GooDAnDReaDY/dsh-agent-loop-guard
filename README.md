...
* **License**: MIT © [GooDAnDReaDY](https://github.com/GooDAnDReaDY)
* **Changelog**: Detailed release history and migration notes are maintained in [CHANGELOG.md](CHANGELOG.md).
